...
export class PirateField {
  draw(drawing: Drawing, field: Model.PirateField, ship: Model.Ship, camera: Camera, starLight: StarLight, casters: ShadowCasters | null): void {
    ...
    field.forEachPirate((pirate) => {
      ...
      this.drawPirate(drawing, pirate, camera.zoom, starLight, casters);
    });
    if (hunting) {
